              ...
              <div className="space-y-6">
                <div className="flex gap-3">
                  ...
                  <p className="text-gray-300">
                    One-of-a-Kind Collectible – A limited edition physical piece
                    designed by JPX, for you to carry with you as a token of our
                    appreciation.
                  </p>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-gray-300">
                    Exclusive Inauguration Event – Witness the unveiling of the
                    Turtle Timepiece, for the first time in history there will
                    be a public offering of a tokenized diamond and you (and an
                    additional guest) can be there to witness it.
                  </p>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-gray-300">
                    ...
                    development of the timeless turtle by influencing its design
                    details.
                  </p>
                </div>
