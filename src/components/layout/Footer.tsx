        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/60 text-sm">
              Preserving timeless assets through generations, ensuring their
              legacy lives on.
            </p>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-gold-400/50"
                required
              />
              <button
                type="submit"
                className="w-full px-4 py-3 bg-gold-400 text-navy-900 rounded-lg font-medium hover:bg-gold-500 transition-colors duration-300"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-white/40 text-sm">
              © 2024 Aquaduct. All rights reserved.
            </div>
